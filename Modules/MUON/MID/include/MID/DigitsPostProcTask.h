...
/// \author My Name
class DigitsPostProcTask final : public quality_control::postprocessing::PostProcessingInterface
{
 public:
  /// \brief Constructor
  DigitsPostProcTask() = default;
  /// \brief Destructor
  ~DigitsPostProcTask() override;
